...
Скрипт отпысывает по одному человеку каждые 45 секунд. Если сделать «быстрее», Истаграм будет блокировать отписки. Чтобы понять, когда сработала блокировка, читайте далее про «кнопку врунишку».
